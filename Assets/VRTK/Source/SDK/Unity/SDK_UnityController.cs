...
namespace VRTK
{
    ...
    public class SDK_UnityController : SDK_BaseController
    {
        ...
        protected List<string> validRightHands = new List<string>()
        {
            ...
            "Oculus Touch - Right",
            "Oculus Quest Controller - Right",//dqh:添加quest手柄支持
            "Oculus Remote"
        };
        protected List<string> validLeftHands = new List<string>()
        {
            ...
            "Oculus Touch - Left",
            "Oculus Quest Controller - Left"//dqh:添加quest手柄支持
        };
        ...
        */
        ...
        public override GameObject GetControllerByIndex(uint index, bool actual = false)
        {
            ...
            if (sdkManager != null)
            {
                if (cachedLeftController != null && cachedLeftController.index == index)
                {
                    ...
                    //Debug.Log(sdkManager.scriptAliasLeftController.name);
        ...
        protected virtual void SetCachedControllerType(string givenType)
        {
            ...
            /*dqh:当为quest时设置为OculusTouch的情况*/
            else if (givenType.Contains("oculus quest"))
            {
                cachedControllerType = ControllerType.Oculus_OculusGamepad;
            }
            //Debug.Log(cachedControllerType);
        }
