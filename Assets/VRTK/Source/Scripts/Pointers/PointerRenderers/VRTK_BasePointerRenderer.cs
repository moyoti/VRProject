...
namespace VRTK
{
    ...
    public abstract class VRTK_BasePointerRenderer : MonoBehaviour
    {
        ...
        {
            Debug.Log(smoothed);
            //pointerOriginTransformFollow.gameObjectToFollow.transform.localPosition+=new Vector3(0,0,10);
            Debug.Log(pointerOriginTransformFollow.gameObjectToFollow.transform.localPosition);
